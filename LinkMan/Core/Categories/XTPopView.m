...
- (instancetype)initWithOrigin:(CGPoint)origin Width:(CGFloat)width Height:(CGFloat)height Type:(XTDirectionType)type Color:(UIColor *)color
{
    ...
    if (self) {
        ...
        self.backGoundView.layer.cornerRadius = 5.0;
        // 添加tableview
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *line = nil;
    if (indexPath.row > 0) {
        line = [[UILabel alloc]initWithFrame:CGRectMake(30, 0, tableView.frame.size.width-60, 1)];
        line.backgroundColor = [UIColor colorWithRed:32/255.0 green:39/255.0 blue:40/255.0 alpha:1.0];
    }
